...
- [ ] The change follows [Architecture](https://github.com/DamNguyenKhang/Capstone-Project/blob/main/docs/ARCHITECTURE.md) and [Contributing](https://github.com/DamNguyenKhang/Capstone-Project/blob/main/CONTRIBUTING.md), or the deviation is explained below.
- [ ] New or changed behavior has the tests required by the [Testing guide](https://github.com/DamNguyenKhang/Capstone-Project/blob/main/docs/TESTING.md).
