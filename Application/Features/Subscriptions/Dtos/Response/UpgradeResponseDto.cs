...
/// <summary>
/// The result of upgrading to a higher-tier plan.
/// </summary>
/// <param name="PaymentRequired">
/// True when <see cref="DueTodayUsd"/> is greater than zero and the client must complete
/// the payment flow using the PayOS fields below before the upgrade activates. False
/// means the prorated credit fully covered the new plan's price and the upgrade already took
/// effect immediately.
/// </param>
/// <param name="DueTodayUsd">The net amount due today after the prorated credit.</param>
...
/// <param name="FirstRenewalDate">Unchanged from the existing billing cycle.</param>
